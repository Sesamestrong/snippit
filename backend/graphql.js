...
type Test {
  ...
  usersLink:[User!]! @idToDoc(idName:"userIds",docType:USER)
  userOptLink:User @idToDoc(idName:"userId",docType:USER)
}
  ...
  USER_ROLE:UserRole,
      ...
      class IdToDocDirective extends SchemaDirectiveVisitor {
        visitFieldDefinition(field) {
          ...
          const {idName,docType}=this.args;
          ...
          //  console.log(type.constructor.name, type.ofType && type.ofType.constructor.name);
          }
        }
